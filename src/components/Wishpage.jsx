      ...
      {loder ?
        ...
        : <div className="text-box" style={{ display: "flex", alignItems: "center", justifyContent: "center", marginTop: "40px", flexDirection: "column" }}>
          ...
          <div className="about-text" style={{ width: "90vw", fontSize: "25px", fontWeight: "bold", color: "#00ff26" }}>
            ...
            {username.name==="CR"?"Frist love or class ka CR kisi ko nahi milta bha bha 😂😂😂. Hello  cr i am not sk rijwan i am ai who know about you . i got all data from rijwan. tum ldki kam ladka jada algte ho. tum hara Attitude dhka ka ladka lagta ha. by the way happy new year to our full Energetic CR.":""}
