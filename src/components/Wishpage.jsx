      ...
      {loder ?
        ...
        : <div className="text-box" style={{ display: "flex", alignItems: "center", justifyContent: "center", marginTop: "40px", flexDirection: "column" }}>
          ...
          <div className="about-text" style={{ width: "90vw", fontSize: "25px", fontWeight: "bold", color: "#00ff26" }}>
            ...
            {username.name==="ritwik"?"Hello bondhu  tui rijwan bondhu tai amro bondhu.Tor baper onk jani tui rijwan ar best frined bol boo na tui rijwan vai hos.vai happy new  year happy thak ar ja sunlam new new bondhu hocha naki kor kor ami achi. akhon question ami k ? bol ami k?":""}
